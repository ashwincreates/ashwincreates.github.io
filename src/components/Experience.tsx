...
function Experience() {
  return (
    <section id="experience" className="min-h-[500px] px-6 md:ml-48 md:pr-24 space-y-20">
      <h3 className="text-stone-300 font-display text-3xl md:text-4xl">Experience</h3>
      <ul className="text-stone-300 space-y-12 space-x-0 md:space-y-0 gap-12 md:flex">
        {experience.map((exp) => (
